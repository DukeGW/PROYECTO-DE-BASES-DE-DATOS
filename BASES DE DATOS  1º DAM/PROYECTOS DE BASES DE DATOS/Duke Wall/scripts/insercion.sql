...
( 1, 'Tabla de surf', null, 5, 120),
( 1, 'Llavero de StarWars', null, 0, 5),
( 1, 'Stannley Cup', null, 436, 33.79),
( 1, 'Vela aroma Oakwood', '2030-12-04', 12, 12.50),
( 1, 'Tira de luces LED', null, 178, 9.98),
( 1, 'Juego de mesa CATAN', null, 2, 80);
